...
1. Major version X (X.y.z | X > 0) MUST be incremented if the set of all
modifications includes backwards incompatible changes to the public API. Patch
and minor version MUST be reset to 0 when major version is incremented.
